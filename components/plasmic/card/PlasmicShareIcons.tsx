...
import sty from "./PlasmicShareIcons.module.css"; // plasmic-import: TTh1AdLIJ6Pk/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaShareSquaresvgIcon
                className={classNames(projectcss.all, sty.svg__e9AB)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaBookmarkSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__l0AhH)}
                role={"img"}
              />
            ),
