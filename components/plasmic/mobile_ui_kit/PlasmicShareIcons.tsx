...
import sty from "./PlasmicShareIcons.module.css"; // plasmic-import: eF322vkNvEYD/css
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaShareSquaresvgIcon
                className={classNames(projectcss.all, sty.svg__h5IzE)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaBookmarkSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__a3Ii)}
                role={"img"}
              />
            ),
