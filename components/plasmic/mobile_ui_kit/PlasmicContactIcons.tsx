...
import sty from "./PlasmicContactIcons.module.css"; // plasmic-import: S52QNAvX1797/css
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <FaPhoneSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__q1Wg6)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaMessageSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__ti1Ck)}
                role={"img"}
              />
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <FaEmailSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__qnJiw)}
                role={"img"}
              />
            ),
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <FaCalendarSolidsvgIcon
                className={classNames(projectcss.all, sty.svg__vzurE)}
                role={"img"}
              />
            ),
