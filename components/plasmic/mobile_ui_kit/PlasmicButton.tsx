...
import sty from "./PlasmicButton.module.css"; // plasmic-import: HZALSXZYRn0N/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaChecksvgIcon
              className={classNames(projectcss.all, sty.svg___6TRb)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <FaArrowRightsvgIcon
              className={classNames(projectcss.all, sty.svg__mpBb)}
              role={"img"}
            />
          ),
