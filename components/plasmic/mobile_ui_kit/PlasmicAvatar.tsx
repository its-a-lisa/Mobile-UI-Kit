...
import sty from "./PlasmicAvatar.module.css"; // plasmic-import: wJBjzkSIjN4M/css
      ...
      >
        {(
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <FaUsersvgIcon
                  className={classNames(projectcss.all, sty.svg___99GBo)}
                  role={"img"}
                />
              ),
        ...
        {(
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__vPdFq)}
                  displayHeight={"auto"}
