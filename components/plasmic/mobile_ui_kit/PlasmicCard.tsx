...
import sty from "./PlasmicCard.module.css"; // plasmic-import: JrxDjy8SC-sL/css
        ...
        >
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <Image
                    className={classNames("__wab_instance", sty.image__ulb8U)}
                    imageSlot={
                      <PlasmicImg__
                        alt={""}
                        className={classNames(sty.img__eSed)}
                        displayHeight={"100%"}
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <Icon
                    className={classNames("__wab_instance", sty.icon___4VDlP)}
                  >
                    <FaBarssvgIcon
                      className={classNames(projectcss.all, sty.svg__dFaCz)}
                      role={"img"}
                    />
                  </Icon>
                ),
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg__b0Jqf)}
                  role={"img"}
                />
              ),
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <Title
                    className={classNames("__wab_instance", sty.title__hX8Ck)}
                    headlineSlot={
                      <Headline
                        className={classNames(
                          "__wab_instance",
          ...
          >
            ...
            >
              {renderPlasmicSlot({
                defaultContents: (
                  <Title
                    className={classNames("__wab_instance", sty.title__kC2RL)}
                    headlineSlot={
                      <Headline
                        className={classNames(
                          "__wab_instance",
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <Content
                  className={classNames("__wab_instance", sty.content__mnUB)}
                  contentSlot={
                    <div
                      className={classNames(
                        projectcss.all,
          ...
          >
            {(
              ...
              ? renderPlasmicSlot({
                  defaultContents: (
                    <Button
                      className={classNames("__wab_instance", sty.button__loWO)}
                    />
                  ),
