...
import sty from "./PlasmicSeparator.module.css"; // plasmic-import: Z-hb0HfwKzQF/css
...
function PlasmicSeparator__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___0T0Zn, {
          [sty.freeBoxorientationShift___0T0Zn6Lm4D]: hasVariant(
            $state,
            "orientationShift",
            "orientationShift"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__gqxK, {
            [sty.freeBoxemphasis_bold__gqxKJoWsq]: hasVariant(
              $state,
              "emphasis",
              "bold"
            ),
            [sty.freeBoxemphasis_contrast__gqxK2YBsb]: hasVariant(
              $state,
              "emphasis",
              "contrast"
            ),
            [sty.freeBoxemphasis_minimal__gqxKWnKqp]: hasVariant(
              $state,
              "emphasis",
              "minimal"
            ),
            [sty.freeBoxemphasis_moderate__gqxK6Xwos]: hasVariant(
              $state,
              "emphasis",
              "moderate"
            ),
            [sty.freeBoxemphasis_subtle__gqxKUr34U]: hasVariant(
              $state,
              "emphasis",
              "subtle"
            ),
            [sty.freeBoxlength__25__gqxKSqep]: hasVariant(
              $state,
              "length",
              "_25"
            ),
            [sty.freeBoxlength__50__gqxK53RGq]: hasVariant(
              $state,
              "length",
              "_50"
            ),
            [sty.freeBoxlength__75__gqxKpmzZc]: hasVariant(
              $state,
              "length",
              "_75"
            ),
            [sty.freeBoxorientationShift__gqxK6Lm4D]: hasVariant(
              $state,
              "orientationShift",
              "orientationShift"
            )
