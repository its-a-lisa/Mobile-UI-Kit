...
import sty from "./PlasmicLabel.module.css"; // plasmic-import: UAdHLLeNvvRK/css
...
export type PlasmicLabel__VariantsArgs = {
  ...
  wrapText?: SingleBooleanChoiceArg<"wrapText">;
  alignment?: SingleChoiceArg<"left" | "center" | "right" | "justified">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.wrapText
      },
      {
        path: "alignment",
        type: "private",
    ...
    >
      <h6
        ...
        className={classNames(projectcss.all, projectcss.h6, sty.labelStack, {
          [sty.labelStackalignment_center]: hasVariant(
            $state,
            "alignment",
            "center"
          ),
          [sty.labelStackalignment_left]: hasVariant(
            $state,
            "alignment",
            "left"
          ),
          [sty.labelStackalignment_right]: hasVariant(
            $state,
            "alignment",
            "right"
          ),
          [sty.labelStackwrapText]: hasVariant($state, "wrapText", "wrapText")
        })}
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            [sty.slotTargetChildrenalignment_center]: hasVariant(
              $state,
              "alignment",
              "center"
            ),
            [sty.slotTargetChildrenalignment_justified]: hasVariant(
              $state,
              "alignment",
              "justified"
            ),
            [sty.slotTargetChildrenalignment_left]: hasVariant(
              $state,
              "alignment",
              "left"
            ),
            [sty.slotTargetChildrenalignment_right]: hasVariant(
              $state,
              "alignment",
              "right"
            ),
            [sty.slotTargetChildrensize_sm]: hasVariant($state, "size", "sm"),
            [sty.slotTargetChildrenwrapText]: hasVariant(
              $state,
              "wrapText",
              "wrapText"
            )
